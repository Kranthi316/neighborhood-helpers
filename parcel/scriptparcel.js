// script.js
const providersData = [
    { id: 1, name: "Parcel Provider A", location: "Location A", price: 20, distance: 10, rating: 4.7 },
    { id: 2, name: "Parcel Provider B", location: "Location B", price: 35, distance: 15, rating: 4.2 },
    { id: 3, name: "Parcel Provider C", location: "Location C", price: 15, distance: 5, rating: 4.8 },
    { id: 4, name: "Parcel Provider D", location: "Location D", price: 40, distance: 20, rating: 3.9 }
];
...
bookServiceBtn.addEventListener("click", () => {
    alert(`Parcel service booked with ${providerName.textContent}`);
    providerProfileModal.style.display = "none";
});
